...
public class ValidationFailedException extends RuntimeException {
    ...
    public ValidationFailedException(String message, Map<String, Collection<String>> errors) {
        super(message);
        this.errors = errors;
    }

    public ValidationFailedException(Map<String, Collection<String>> errors) {
        super(formatMessage(errors));
        this.errors = errors;
    }

    public ValidationFailedException(String key, String error) {
